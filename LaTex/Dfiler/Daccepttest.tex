...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] l@{}}
    ...
    ~ &\textit{Hovedforløb} & ~ & ~ &
    \\ \midrule
    1. & Start system &   Kalibrerings-vinduet og seneste kalibreringstidspunkt vises  &   Kalibrerings-vinduet og seneste kalibreringstidspunkt vises  &		{\Huge \checkmark}
    \\
...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] l@{}}
	...
	&\textit{Hovedforløb} & & & 
	\\ \midrule
	1. &Udfør Use Case 1 og observér Monitor-vinduet & Det filtrerede blodtrykssignal samt systole-, diastole- og pulsværdier udskrives i Monitor-vinduet & Det filtrerede blodtrykssignal samt systole-, diastole- og pulsværdier udskrives i Monitor-vinduet & {\Huge \checkmark}
	\\ \midrule
		~ &\textit{Undtagelse} & ~ & ~ & 
	\\ \midrule
	\\ \bottomrule
...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] l@{}}
    ...
    ~ &\textit{Hovedforløb} & ~ & ~ &
    \\ \midrule
    1. & Tryk på "Nulpunktsjustér"\--knap &    System nulpunktsjusterer  &  System nulpunktsjusterer  &		{\Huge (\checkmark)}
    \\
