...
Kommunikationsprotokol for hardwareblokkene ses i Tabel 2.3. Det er en beskrivelse og specifikation af hvilket indgangs- og udgangssignal, de forskellige hardwareblokke har. 
\\  \\
...
\subsection{bdd}
På Figur 2.3 ses bdd for Signalbehandlingsblokken, hvor Forstærkerblokkens og Filterblokkens indgangs- og udgangsporte er vist.  
\begin{figure}[H]
	\centering
