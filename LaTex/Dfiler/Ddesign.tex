...
For systemet er der valgt, at tryktransducerens målbare område skal ligge i intervallet 0-300 mmHg. Den maksimale udgangsspænding bliver derfor udtrykt fra det maksimale tryk på 300 mmHg, sensitiviteten på 5 $\mu$ og indgangsspændingen på 9 V. 

\begin{equation}
	V_{max} = 300 mmHg \cdot 5\mu V \cdot 9 V\\
\end{equation}
\begin{equation}
	V_{max} = 13,5 mV
\end{equation}
...
\begin{longtabu} to \linewidth{@{}l l l l X[j]@{}}
	...
	Signalbehandling  & Analogt & in & Spænding & +/- 13,5 mV \\[-1ex]
...
Forstærkerblokken sørger for, at det meget svage spændingssignal fra tryktransduceren bliver forstærket op til en spænding, der ligger indenfor det måleinterval, der svarer til DAQ'en, som er +/- 5 V. 
...
\begin{longtabu} to \linewidth{@{}l l l l X[j]@{}}
	...
	Forstærker & Batteri & in & Spænding & +/- 9 V \\[-1ex]
			   & Analogt & in & Spænding & +/- 13,5 mV \\[-1ex]
...
\end{longtabu}
 ...
 \begin{itemize}
 	...
 	\begin{equation}
 		...
 		Gain = \frac{5 V}{13,5 mV}\\ \Longrightarrow \\
 		Gain = 370
 	\end{equation}
 	
 	
 	
 	\item Indgangspænding: +/- 13,5 mV
