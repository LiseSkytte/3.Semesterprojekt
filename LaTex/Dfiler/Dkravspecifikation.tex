...
\begin{tabularx}{\textwidth}{l X}
     ...
     \midrule
     Aktørnavn & Transducer \\
     Type & Sekundær \\
     Beskrivelse  & Transducer måler og omformer trykket fra Måleobjekt til et analogt signal \\ 
     \midrule
...
\begin{longtabu} to \linewidth{@{}l r X[j]@{}} %UC1%
    ...
    Hovedforløb &    1. &	 Kalibrering-vinduet vises\\[-1ex]  				
    			&    2. &    Tidligere kalibreringsdato vises og System spørg om der ønskes en kalibrering \newline
    			&    3.	&	 Forsker trykker på "Ja"\--knappen \newline\\ \midrule
    						 [3.a \textit{Forsker trykker på "Nej"\--knappen}]\\
