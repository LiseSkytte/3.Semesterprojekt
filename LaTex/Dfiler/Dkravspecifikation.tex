...
\begin{longtabu} to \linewidth{@{}l r X[j]@{}} %UC1%
    ...
    Hovedforløb &    1. &	 Kalibrering-vinduet vises ved opstart\\[-1ex]  				
    			...
    			&    4.	&	 Forsker vælger at udføre kalibrering\newline
    						 [4.a \textit{Indtastede kalibreringsdata ugyldige}]\\
                &    5.	&	 System kalibrerer\\
...
\begin{longtabu} to \linewidth{@{}l r X[j]@{}} %UC6%
    ...
    Hovedforløb &    1. &    Forsker skriver kommentar og bestemmer 						 maximum længde for måling \newline
    						 [1.a \textit{Forsker ændrer ikke maximum længden for måling}]\newline
    						 [1.b \textit{Forsker skriver ikke en kommentar til måling}]\\ 
                &    2. &    Forsker igangsætter optagelse af måling 		 \\[-1ex] 
                &    3.	&	 Forsker stopper optagelse af måling 			 \newline
                			 [3.a \textit{Maximum længde for måling er nået}]\\
                &	 4. &    System åbner Gem-vinduet \newline
                			 [4.a \textit{Måleobjekts data er gemt fra forrige måling}]\\ 
                &	 5. &	 Forsker indtaster metadata for 					 blodtryksmåling \\[-1ex]
                &	 6. &	 Forsker trykker på "OK"\--knappen 				 \\[-1ex]
                &	 7. &	 System gemmer måling \\[-1ex]
                &	 8.	&	 Det fremgår af Monitor-vinduet at måling 		 er gemt\newline\\ \midrule
                
    Undtagelser &    1.a &   Forsker ønsker ikke at ændre maximum 				længde for måling. Forsætter ved punkt 2 i UC6 \\
    			&    1.b &   Forsker ønsker ikke at tilknytte en kommentar til måling. Forsætter ved punkt 2 i UC6 \\
    			&    3.a &   System stopper optagelse af måling. Forsætter ved punkt 4 i UC6  \\
    			&	 4.a &	 Forsætter ved punkt 7 i UC6. \\ \bottomrule
