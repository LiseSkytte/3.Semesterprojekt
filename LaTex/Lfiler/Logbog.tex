...
\\\textbf{Dagsorden}\\ Nu skal der skrives logbøger.\begin{itemize}	\item Her kan der stå et punkt
	\item Her kan stå endnu et punkt
	\item Jeg lærer langsomt hvordan punkterne virker.
	\item Jeg håber ikke jeg har ødelagt noget i vores dokumenter.
\end{itemize}
...
Dagsorden:\begin{itemize}	\item Ordliste: Signalbehandling
	...
	\item Nyt aktør kontekst diagram
