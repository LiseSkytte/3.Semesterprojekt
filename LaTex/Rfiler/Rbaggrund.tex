...
\begin{figure}[H]
	...
	\caption{Diagram over knækfrekvensen og dæmpningsfaktoren påvirket af bobler og uden, \protect\cite[s. 306]{Billed for invasiv blodtryksmaling}}
\end{figure}
...
For baggrundsafsnittet er der blevet benyttet følgende referancer, \cite{Billed for invasiv blodtryksmaling},  \cite{Legemkredslob billede}, \cite{Hjertecyklus}, \cite{Wheatestone}, \cite{Diashow},   \cite{Sundhedbog},   
